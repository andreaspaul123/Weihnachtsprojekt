...
if windows_
matlabFunction(M,'File', 'Matlab_Skripte\Systemmatrizen\DynimakMatritzen\calc_M', ...
    'Vars', {y, sys_param});
matlabFunction(D,'File', 'Matlab_Skripte\Systemmatrizen\DynimakMatritzen\calc_D', ...
    'Vars', {y, y_dot, sys_param});
matlabFunction(G,'File', 'Matlab_Skripte\Systemmatrizen\DynimakMatritzen\calc_G', ...
    'Vars', {y, sys_param});
matlabFunction(tau_R,'File', 'Matlab_Skripte\Systemmatrizen\DynimakMatritzen\calc_tau_R', ...
